...
spm_encode --model=$model_dir/sentence.bpe.model < $DATA/en-ro.vaccine.en > $DATA/en-ro.abstracts.mbart.spm.en_XX
spm_encode --model=$model_dir/sentence.bpe.model < $DATA/en-ro.vaccine.ro > $DATA/en-ro.abstracts.mbart.spm.ro_RO
